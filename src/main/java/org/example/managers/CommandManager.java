...
/**
 * Менеджер команд, отвечающий за регистрацию, выполнение и отслеживание истории команд.
 * Также предотвращает рекурсивное выполнение скриптов
 */
...
public class CommandManager {
    ...
    /**
     * Выполняет команду по её имени с заданными аргументами.
     *
     * @param commandName имя команды
     * @param args        массив аргументов команды
     * @throws IllegalArgumentException если команда с таким именем не зарегистрирована
     */
